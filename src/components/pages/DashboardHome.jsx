        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="p-4 rounded-xl bg-blue-50 hover:bg-blue-100 transition-colors duration-300 text-center">
              <i className="ri-user-add-line text-blue-600 text-2xl mb-2 block" />
              <span className="text-sm font-medium text-blue-600">Add Student</span>
            </button>
            <button className="p-4 rounded-xl bg-teal-50 hover:bg-teal-100 transition-colors duration-300 text-center">
              <i className="ri-book-line text-teal-600 text-2xl mb-2 block" />
              <span className="text-sm font-medium text-teal-600">New Course</span>
            </button>
